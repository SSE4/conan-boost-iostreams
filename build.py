...
if __name__ == "__main__":
    ...
    if reponame_t or reponame_a:
        ...
        print("DEBUG reponame_t = " + reponame_t)
        print("DEBUG repobranch_t = " + repobranch_t)
        print("DEBUG username, repo  = " + username + ", " + repo )
        print("DEBUG channel, version = " + channel + ", " +  version )
